...
const pendingTasksNumb = document.querySelector(".notification");
pendingTasksNumb.textContent = UI.length;

// search filter
const search = document.getElementById("search");
const todoCard = document.querySelectorAll(".col-md");
search.addEventListener("keyup", () => {
    console.log(search.value)
    todoCard.forEach(post => {
        if (post.innerText.toLowerCase().includes(search.value.toLowerCase())) {
